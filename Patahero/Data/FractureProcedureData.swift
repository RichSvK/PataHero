let armProcedure = [
    FractureProcedure(step: "Lilitkan perban untuk membalut lengan sebagai penyangga awal", imagePath: "lengan-step1", order: 1),
    ...
    FractureProcedure(step: "Hubungi kontak darurat Eka Hospital", imagePath: "lengan-step4", order: 4),
]

let fingerProcedure = [
    FractureProcedure(step: "Balut jari yang patah dengan jari sebelahnya sebagai penyangga", imagePath: "jari-step1", order: 1),
    ...
    FractureProcedure(step: "Hubungi kontak darurat Eka Hospital", imagePath: "jari-step4", order: 4),
]
